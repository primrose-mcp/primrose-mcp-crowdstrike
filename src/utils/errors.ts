 ...
 *
 * Custom error classes and error handling helpers for CrowdStrike API.
 */

/**
 * Base CrowdStrike API error
 */
export class CrowdStrikeApiError extends Error {
  ...
  constructor(message: string, statusCode?: number, code?: string, retryable = false) {
    ...
    this.code = code || 'CROWDSTRIKE_ERROR';
 ...
 */
export class RateLimitError extends CrowdStrikeApiError {
 ...
 */
export class AuthenticationError extends CrowdStrikeApiError {
 ...
 * Not found error
 */
export class NotFoundError extends CrowdStrikeApiError {
 ...
 * Validation error
 */
export class ValidationError extends CrowdStrikeApiError {
